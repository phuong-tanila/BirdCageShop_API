...
{
    public partial class BirdCageShopContext : IdentityDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost,1433;Initial Catalog=BirdCageShop;User=sa;Password=12345;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;");
            }
        }
